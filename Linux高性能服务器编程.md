...
![image-20231226105001463](https://md-jomo.oss-cn-guangzhou.aliyuncs.com/IMG/image-20231226105001463.png)
...
int main(int argc, void *argv)
{
    ...
    while (1)
    {
        rset = oldset; // 每次都要将oldset赋值给需要监听的集合rset
        ...
        { // 监听到了文件描述符变化
            ...
            if (FD_ISSET(lfd, &rset))
            {
                ...
                // 将cfd添加至oldset集合中，用于下次监听
                FD_SET(cfd, &oldset);

                // 更新maxfd，提取出的cfd不一定是最大的
                if (cfd > maxfd)
                {
                    maxfd = cfd;
                }
            ...
            // cfd（cfd可以有多个）
            // 遍历lfd之后的文件描述符是否在rset集合中，如果在则说明cfd变化
...
![image-20231226124802645](https://md-jomo.oss-cn-guangzhou.aliyuncs.com/IMG/image-20231226124802645.png)
